# 7. eosio.forum A simple forum, messaging and voting system for BOS
...
The [direnv](https://direnv.net/) tool can be used to automatically import those variables when you `cd` in the project's root directory.
